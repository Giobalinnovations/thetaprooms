  ...
  return (
    <>
        ...
        {CartData.items.map((item, key) => (
          ...
          >
            <a
              ...
              onClick={e => removeFromCart(e, key)}
            >
              ×
            </a>
            <Link href="/product">
      ...
      <p className="woocommerce-mini-cart__total total">
        ...
        <span className="woocommerce-Price-amount amount">
          <bdi>
            <span className="woocommerce-Price-currencySymbol">$</span>298.00
          </bdi>
        </span>
      </p>
      <p className="woocommerce-mini-cart__buttons buttons">
        <Link href="/cart" className="tst-btn tst-btn-2">
          View cart
        </Link>
        <Link href="/checkout" className="tst-btn">
          Checkout
        </Link>
      </p>
    </>
