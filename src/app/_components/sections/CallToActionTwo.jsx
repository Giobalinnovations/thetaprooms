            ...
            <div className="col-lg-6">
              ...
              <div className="tst-cta-frame">
                <div className="tst-cta">
                  ...
                  <h2
                    className="tst-white-2 tst-text-shadow tst-fade-up tst-mb-30"
                  ...
                  <a
                    ...
                    className="tst-btn tst-btn-lg tst-btn-shadow tst-anima-link tst-fade-up tst-mr-30"
                  >
                    {Data.button1.label}
                  </a>
                  <a
                    href={Data.button2.link}
                    className="tst-label tst-res-btn tst-white-2 tst-fade-up"
                  >
                    {Data.button2.label}
                  </a>
                </div>
